...
if(isset($_POST['next'])){
   ...
   for($i=1;$i<=$no_of_modules;$i++){
       ...
       $query = "Insert into module(subject_id,module_number,module_name) values ($subject_id,$i,'$module_name')";
...
<?php require_once("teacher_header.php");  ?>
  ...
  <div class="register-box-body">
    ...
    <input type='hidden' class='form-control' placeholder='subject_id' name="subject_id"  value="<?php echo $subject_id; ?>">
      <?php
        for($i=1;$i<=$no_of_modules;$i++){?>
           <div class="row">
           <?php
            ...
            <input type='text' class='form-control' placeholder='Chapter Name' name='chapter_name_$i'>
        </div>  
            </div>";
//        }
        ?>
        <div class="col-md-6">
              ...
              <select name="module_id_<?php echo $i; ?>" class="input-field form-control "id="department">
                <option value="" selected class="input-field">Select Module..</option>
                <?php
                 require_once("../includes/db.php");
                 global $connection;
                  $query ="select * from module where subject_id = $subject_id";
