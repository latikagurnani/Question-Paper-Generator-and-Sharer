...
function displayquestions(){
    ...
    $_SESSION['module'] = $module_ids;
    $_SESSION['chapter'] = $chapter_ids;
...
//        echo $marks;
  ...
  {
   global $connection;
   $question_id = $_GET['add'];
   
?>


          <form action="manage_questions_added.php">
           
            <input type="text" value="" class="form-control" name="question_statement" placeholder="Question Statement">
             <input type="text" value="" class="form-control" name="difficulty" placeholder="Question Difficulty">
             <input type="text" value="" class="form-control" name="marks" placeholder="Marks ">
             <br>
             <input style="margin-bottom:25px;" type="submit" class="btn btn-primary" name ="added" value = "add Question">
...
?> 
                ...
                <div class="col-md-3">
                <li class="list-group-item list-group-item-success"><a href="#">Add Question</a></li>
                </div>
            </div>
        </div>
    </div>
