...
//        echo $marks;
       ...
       if($marks == 0)
       {
        ...
        echo"<td>$marks</td>";
        echo"<td><a href = 'display_manage_questions_again.php?delete={$question_id}&subject={$subject_ids}&module={$module_ids}&chapter={$chapter_ids}'>Delete</a></td>";
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
          <li><a href="managequestions.php"><i class="fa fa-paper-plane"> Manage Questions</i></a></li>
