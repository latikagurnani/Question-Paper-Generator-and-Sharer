...
<!--            <a href="student_register.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>-->
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
<!--              <h3>53</h3>-->
                ...
                $query="select * from generated_paper_by_teacher where generated_by=$teacher_id";
                $result = mysqli_query($connection, $query);
